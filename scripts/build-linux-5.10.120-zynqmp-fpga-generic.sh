...
sh ../patchs/linux-$KERNEL_VERSION-xlnx-v2021.2-patchs/0xx_patch.sh

### Patch for builddeb

patch -p1 < ../patchs/linux-$KERNEL_VERSION-builddeb.diff 
git add --all
...
cp -r ../patchs/microchip-wilc-driver/wilc1000 drivers/staging/wilc3000
patch -d drivers/staging/wilc3000 < ../patchs/microchip-wilc-driver/0001-ultra96-modifications-15.5.patch
patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga-wilc3000.diff
patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga-pwrseq-wilc.diff
git add --all
git commit -m "[add] drivers/staging/wilc3000"

### Patch for zynqmp-fpga

patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga.diff 
git add --all
git commit -m "[patch] for linux-$KERNEL_VERSION-zynqmp-fpga."

### Patch for Ultra96

patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga-ultra96.diff
git add --all
git commit -m "[patch] for Ultra96."

### Patch for UltraZed-EG IO Carrier Card

patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga-uz3eg-iocc.diff 
git add --all
git commit -m "[patch] for UltraZed-EG IO Carrier Card."

### Patch for Ultra96-V2

patch -p1 < ../patchs/linux-$KERNEL_VERSION-zynqmp-fpga-ultra96v2.diff 
git add --all
